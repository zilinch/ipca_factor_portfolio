...
from ipca_utils import IPCA_factor_v3
...
def ipca_step_t(t, window_size, df_ipca, unique_dates, K, characteristics, log_fp, ipca_fp):
    ...
    # Fit ipca
    try:
        Gamma, Factors, r_t, excess_r_t, X_last = IPCA_factor_v3(window_data, characteristics, K)
...
def main():
    ...
    ipca_fp = f"results/IPCA_intermediates_v3/"
