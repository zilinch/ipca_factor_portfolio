...
from ipca_utils import IPCA_factor_v4 # Same as v4, just increased factor number to 8
...
def ipca_step_t(t, window_size, df_ipca, unique_dates, K, characteristics, log_fp, ipca_fp):
    ...
    # Fit ipca
    try:
        # Same as v4, just increased factor number to 8
        Gamma, Factors, r_t, excess_r_t, X_last = IPCA_factor_v4(window_data, characteristics, K)
